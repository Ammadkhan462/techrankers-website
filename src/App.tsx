      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <a href="/" className="flex items-center space-x-1 group">
            <img src="/logo.png" alt="TechRankers" className="h-12 w-auto group-hover:scale-110 transition-transform" />
          </a>
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <img src="/logo.png" alt="TechRankers" className="h-10 w-auto" />
            </div>
